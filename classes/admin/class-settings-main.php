...
class MPT_Admin_Settings_Main {
	...
	public static function get_settings_sections( ) {
		$sections = array(
			...
			array(
				'id' => 'mpt-emails',
				'tab_label' => __( 'Emails', 'mpt' ),
				'title' => __( 'Admin email for Member Registration', 'mpt' ),
				'desc' => __( 'Management of email notification to the site administrator when a new member joins the site.', 'mpt' ),
			)
		);
		return $sections;
	}
	...
	public static function get_settings_fields( ) {
		$settings_fields = array(
			...
			'mpt-emails' => array(
				array(
					'name' => 'recipient_admin_email',
					'label' => __( 'Recipient Email', 'mpt' ),
					'type' => 'text',
					'default' => get_option( 'admin_email' ),
					'desc' => __( 'By default this is the administrator\'s email of the site but you can change the recipient.', 'mpt' )
				),
				array(
					'name' => 'subject_admin_email',
					'label' => __( 'Subject email', 'mpt' ),
					'type' => 'text',
					'default' => __( '[%%blog_name%%] New Member Registration', 'mpt' ),
				),
				array(
					'name' => 'content_admin_email',
					'label' => __( 'Content email', 'mpt' ),
					'type' => 'textarea',
					'default' => __( "New member registration on your site %%blog_name%%:\n\nUsername: %%username%%\nE-mail: %%user_email%%", 'mpt' ),
				...
				array(
					...
					'desc' => __( 'Management of email notification by a Member upon registration.', 'mpt' ),
					'type' => 'metabox',
				),
				array(
					'name' => 'member_register_subject_email',
					'label' => __( 'Subject email', 'mpt' ),
					'type' => 'text',
					'default' => __('[%%blog_name%%] Your username and password', 'mpt'),
				),
				array(
					'name' => 'member_register_content_email',
					'label' => __( 'Content email', 'mpt' ),
					'type' => 'textarea',
				...
				array(
					'name' => 'admin_email_member_lost_pwd',
					'label' => __( 'Admin email for Member lost password', 'mpt' ),
					'desc' => __( 'Management of email notification to the administrator when a member has lost his password.', 'mpt' ),
					'type' => 'metabox',
				),
				array(
					'name' => 'recipient_admin_email_lost_pwd',
					'label' => __( 'Recipient Email', 'mpt' ),
					'type' => 'text',
					'default' => get_option( 'admin_email' ),
					'desc' => __( 'By default this is the administrator\'s email of the site but you can change the recipient.', 'mpt' )
				...
				array(
					'name' => 'admin_lost_pwd_subject_email',
					'label' => __( 'Subject email', 'mpt' ),
					'type' => 'text',
					'default' => __('[%%blog_name%%] Password Lost/Changed', 'mpt' ),
				),
				array(
					'name' => 'admin_lost_pwd_content_email',
					'label' => __( 'Content email', 'mpt' ),
					'type' => 'textarea',
				...
				array(
					'name' => 'member_lost_pwd_email',
					'label' => __( 'Member lost password email', 'mpt' ),
					'desc' => __( 'Management of email notification by a Member lost his password.', 'mpt' ),
					'type' => 'metabox',
				),
				array(
					'name' => 'member_lost_pwd_subject_email',
					'label' => __( 'Subject email', 'mpt' ),
					'type' => 'text',
					'default' => __('[%%blog_name%%] Password Reset', 'mpt' ),
				),
				array(
					'name' => 'member_lost_pwd_content_email',
					'label' => __( 'Content email', 'mpt' ),
					'type' => 'textarea',

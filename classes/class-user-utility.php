...
class MPT_User_Utility {
	 ...
	 * detail creation of a user, use MPT_User_Utility::insert_user() to specify more infomation.
	 *
	 * @see MPT_User_Utility::insert_user() More complete way to create a new user
	 *
